...
static void __iommu_dma_unmap_batched(struct device *dev, dma_addr_t dma_addr,
		size_t size, dma_addr_t min_dma, size_t inv_size)
{
	...
	if (!iotlb_gather.queued && inv_size)
		iommu_iotlb_sync_batched(domain, &iotlb_gather, min_dma, inv_size);
...
static void iommu_dma_unmap_page_batched(struct device *dev, dma_addr_t dma_handle,
		size_t size, enum dma_data_direction dir, unsigned long attrs, dma_addr_t min_dma, size_t inv_size)
{
	struct iommu_domain *domain = iommu_get_dma_domain(dev);
	phys_addr_t phys;
	...
	__iommu_dma_unmap_batched(dev, dma_handle, size, min_dma, inv_size);
...
static const struct dma_map_ops iommu_dma_ops = {
	...
	.unmap_page_batched = iommu_dma_unmap_page_batched,
